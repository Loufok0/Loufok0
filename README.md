...
|---------|-------------|------|
| **[miniRT](https://github.com/Loufok0/miniRT)** | Raytracing project from 42 | C |
| **[B-12](https://github.com/Loufok0/B-12)** | Arduino Nano project - inspo from [stray](https://en.wikipedia.org/wiki/Stray_(video_game))! | C++ |
